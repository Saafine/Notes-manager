...
class ShowDocuments extends React.Component {
  renderNotes() {
    ...
    let prevFilteredNotes = JSON.parse(JSON.stringify(userFolders)); // deep cloning the object to perform sorting without mutating original data
    ...
    console.log('showing documnets'); // !todo remove
